...
void CSerialPort::SetWriteTimeout(unsigned long dwTotalMultip,unsigned long dwTotalConst) {
	COMMTIMEOUTS Timeouts;
	GetTimeouts(Timeouts);
	Timeouts.WriteTotalTimeoutMultiplier = dwTotalMultip;
	Timeouts.WriteTotalTimeoutConstant = dwTotalConst;
	SetTimeouts(Timeouts);
	}
...
void CSerialPort::SetReadTimeout(unsigned long dwInterval,unsigned long dwTotalMultip,unsigned long dwTotalConst) {
	COMMTIMEOUTS Timeouts;
	GetTimeouts(Timeouts);
	Timeouts.ReadIntervalTimeout = dwInterval;
	Timeouts.ReadTotalTimeoutMultiplier = dwTotalMultip;
	Timeouts.ReadTotalTimeoutConstant = dwTotalConst;
	SetTimeouts(Timeouts);
	}
