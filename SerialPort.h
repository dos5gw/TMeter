...
{
public:
	void SetWriteTimeout(unsigned long dwTotalMultip,unsigned long dwTotalConst);
	void SetReadTimeout(unsigned long dwInterval,unsigned long dwTotalMultip,unsigned long dwTotalConst);
//Enums
  enum FlowControl
  {
    NoFlowControl,
